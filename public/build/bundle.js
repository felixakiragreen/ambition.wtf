    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(footer, "class", "svelte-1s4baex");
    			add_location(footer, file$3, 38, 2, 873);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "ambition_640.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "class", "svelte-1s4baex");
    			add_location(img0, file$3, 14, 1, 215);
    			add_location(p0, file$3, 16, 1, 262);
    			add_location(h1, file$3, 20, 45, 359);
    			attr_dev(a0, "href", "https://hexis.wtf");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "class", "svelte-1s4baex");
    			add_location(a0, file$3, 20, 1, 315);
    			add_location(p1, file$3, 21, 1, 383);
    			attr_dev(a1, "href", "https://twitter.com/felixakiragreen");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-1s4baex");
    			add_location(a1, file$3, 23, 30, 469);
    			attr_dev(span0, "class", "nb svelte-1s4baex");
    			add_location(span0, file$3, 23, 2, 441);
    			attr_dev(a2, "href", "https://twitter.com/trentonmcbeth");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "class", "svelte-1s4baex");
    			add_location(a2, file$3, 24, 23, 577);
    			attr_dev(span1, "class", "nb svelte-1s4baex");
    			add_location(span1, file$3, 24, 2, 556);
    			add_location(p2, file$3, 22, 1, 435);
    			attr_dev(img1, "id", "hexis");
    			if (img1.src !== (img1_src_value = "hexis_640.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "class", "svelte-1s4baex");
    			add_location(img1, file$3, 26, 1, 670);
    			set_style(span2, "color", "var(--grey-400)");
    			add_location(span2, file$3, 29, 2, 717);
    			set_style(span3, "color", "var(--grey-100)");
    			add_location(span3, file$3, 30, 2, 774);
    			add_location(p3, file$3, 28, 1, 711);
    			add_location(div0, file$3, 33, 1, 839);
    			attr_dev(div1, "class", "hexis svelte-1s4baex");
    			add_location(div1, file$3, 18, 1, 293);
    			attr_dev(main, "class", "svelte-1s4baex");
